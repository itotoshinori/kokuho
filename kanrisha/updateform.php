...
<FORM name="form1" method="post" action="list.php" enctype="multipart/form-data" required>
...
if($houmonbi<>"0000-00-00"){
?>
訪問日：<INPUT type="text" name="houmonbi" value="<?=htmlspecialchars($row['houmonbi'])?>">
<?php
}else{
...
//echo "<INPUT type='hidden' name='ac' value='shinki'>;
}
?>
<p>
